import { Controller, Get, Post, Body, UseGuards, HttpStatus, Param } from '@nestjs/common';
...
export class NoticeController {
  ...
  async createNotice(@Body() createNoticeDto: CreateNoticeDto) {
    const notice = await this.noticeService.createNotice(createNoticeDto.message);
    return {
